...
{
    public static class EventDBRepository<T> where T : class
    {
        public static string uri = "https://skyfire.documents.azure.com:443/";
        public static string key = "primarykey";
        public static string database = "Events";
        public static string collection = "Surveys";
